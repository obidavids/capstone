...
DATABASES = {
    'default': {
        ...
        'HOST': 'obi-aws-capstone-rds.cl0eu0cwgvbb.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesobiblog' # please enter your s3 bucket name
